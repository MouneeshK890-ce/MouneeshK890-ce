...
# 💻 Tech Stack:
#### 🌐 Core Web:
![HTML5](https://img.icons8.com/color/50/html-5--v1.png) ![CSS3](https://img.icons8.com/color/50/css3.png) ![JavaScript](https://img.icons8.com/color/50/javascript--v1.png) ![Responsive Design](https://img.icons8.com/external-flaticons-lineal-color-flat-icons/50/external-responsive-design-computer-programming-flaticons-lineal-color-flat-icons.png)
#### ⚛️Frontend:
![React.js](https://img.icons8.com/external-tal-revivo-color-tal-revivo/50/external-react-a-javascript-library-for-building-user-interfaces-logo-color-tal-revivo.png) ![TypeScript](https://img.icons8.com/external-tal-revivo-color-tal-revivo/50/external-typescript-an-open-source-programming-language-developed-and-maintained-by-microsoft-logo-color-tal-revivo.png) ![Redux](https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/50/external-redux-an-open-source-javascript-library-for-managing-application-state-logo-shadow-tal-revivo.png) ![Tailwind CSS](https://img.icons8.com/color/55/tailwindcss.png) ![Bootstrap](https://img.icons8.com/color/60/bootstrap--v2.png) ![jQuery](https://img.icons8.com/external-tal-revivo-color-tal-revivo/50/external-jquery-is-a-javascript-library-designed-to-simplify-html-logo-color-tal-revivo.png)

#### 🛠 Tools & WorkFlow:
![npm](https://img.icons8.com/external-tal-revivo-color-tal-revivo/50/external-npm-a-package-manager-for-the-javascript-programming-language-logo-color-tal-revivo.png) ![Vite](https://img.icons8.com/fluency/48/vite.png) ![Vs Code](https://img.icons8.com/color/48/visual-studio-code-2019.png) ![Postman (API Testing)](https://img.icons8.com/dusk/50/postman-api.png) ![Git](https://img.icons8.com/color/55/git.png) ![Firebase](https://img.icons8.com/external-tal-revivo-color-tal-revivo/55/external-firebase-a-googles-mobile-platform-that-helps-you-quickly-develop-high-quality-apps-logo-color-tal-revivo.png) ![Netlify](https://img.icons8.com/external-tal-revivo-color-tal-revivo/50/external-netlify-a-cloud-computing-company-that-offers-hosting-and-serverless-backend-services-for-static-websites-logo-color-tal-revivo.png)
